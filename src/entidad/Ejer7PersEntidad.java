...
public class Ejer7PersEntidad {
    ...
    public Ejer7PersEntidad() {
    }

    public Ejer7PersEntidad(String nombre, int edad, char sexo, double peso, double altura, int calcularIMC, boolean esMayorDeEdad) {
        this.nombre = nombre;
        this.edad = edad;
        this.sexo = sexo;
        this.peso = peso;
    ...
    public String toString() {
        return "Ejer7PersEntidad{" + "nombre =" + nombre + ", edad =" + edad + ", sexo =" + sexo + ", peso =" + peso + ", altura =" + altura + ", calcularIMC =" + calcularIMC + ", esMayorDeEdad =" + esMayorDeEdad + '}';
    }
